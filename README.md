...
![ALU Waveform Result](./sub-folder-01-8-bit-ALU/alu_waveform.png)
...
### 2. Combinational Logic Designs
* **Half Adder:**
    ![Half Adder Waveform](./sub-folder-03-Combinational-Logic/half_adder_waveform.png)
* **Full Adder:**
    ![Full Adder Waveform](./sub-folder-03-Combinational-Logic/full_adder_waveform.png)
* **Full Adder using 2 Half Adders:**
    ![FA using HA Waveform](./sub-folder-03-Combinational-Logic/full_adder_using_2_half_adder_waveform.png)
* **4:1 Multiplexer:**
    ![4:1 Mux Waveform](./sub-folder-03-Combinational-Logic/4_to_1_mux_waveform.png)
...
* **SR Flip-Flop:**
    ...
    * **Waveform Result:**
    ![SR Flip-Flop Waveform](./sub-folder-04-Sequential-Circuits/sr_ff_waveform.png)
